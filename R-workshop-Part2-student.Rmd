...
myUSPersonalExpenditure$expenditure  <- as_tibble(myUSPersonalExpenditure)
 USPersonalExpenditure_long <- pivot_longer(cols = starts_with("19"), names_to = "year", values_to = "amount")
