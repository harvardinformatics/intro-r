...
For this workshop, our data set comes from... wait for it ... penguins! The [palmerpenguins :octicons-link-external-24:](https://allisonhorst.github.io/palmerpenguins/){:target="_blank"} data set contains measurement data for 3 species of penguins collected on three islands at the LTER site in the Palmer Archipelago, Antarctica. *palmerpenguins* is itself an R package that we can load like other packages after it has been installed:
